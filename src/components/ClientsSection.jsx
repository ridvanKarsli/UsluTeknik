  ...
  return (
    <>
      ...
      <section id="clients" ref={sectionRef} className="py-20 md:py-32 bg-gradient-to-b from-white via-gray-50 to-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-slate-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-800 to-blue-700 mx-auto rounded-full"></div>
          </div>
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-4 z-10 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
                    ...
                    {panel.clients.length > 0 && (
                      <>
                        <div className="w-20 h-1 bg-gradient-to-r from-blue-600 to-blue-500 mb-4 rounded-full"></div>
                  ...
                  {panel.hasIcon && (
                    <div className="absolute top-4 right-4 z-10 group-hover:scale-110 transition-transform duration-300">
                      <div className="w-14 h-14 bg-gradient-to-br from-blue-700 to-blue-600 rounded-full flex items-center justify-center shadow-xl">
