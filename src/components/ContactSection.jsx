      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 md:mb-20 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-sans font-bold text-gray-900 mb-6">
            Bizimle <span className="text-gradient-cyan">İletişime Geçin</span>
          </h2>
          ...
          <div className={`space-y-6 ${isVisible ? 'animate-slide-in-left' : 'opacity-0'}`}>
                ...
                <div className="flex items-start relative z-10">
                  <div className="flex-shrink-0">
                    <div className={`relative bg-gradient-to-br ${info.gradient} rounded-xl p-4 text-white group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}>
                      {info.icon}
                      <div className={`absolute inset-0 bg-gradient-to-br ${info.gradient} rounded-xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300 -z-10`}></div>
                    </div>
                  </div>
                  <div className="ml-5 flex-1">
                    <h4 className="text-lg font-sans font-bold text-gray-900 mb-2 group-hover:text-gradient-cyan transition-all duration-300">
                      {info.title}
                    </h4>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-lg font-sans font-bold text-gray-900">Çalışma Saatleri</h4>
              </div>
